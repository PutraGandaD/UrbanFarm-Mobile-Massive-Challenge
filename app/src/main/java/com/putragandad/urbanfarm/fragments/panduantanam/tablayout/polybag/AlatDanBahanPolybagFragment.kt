...
class AlatDanBahanPolybagFragment : Fragment() {
    private val api by lazy { ApiRetrofit().endpoint }
    private var _binding : FragmentAlatDanBahanPolybagBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentAlatDanBahanPolybagBinding.inflate(inflater, container, false)

        namaTanaman = setNamaTanamanValue()
        metodeTanam = setMetodeTanamValue()
//        Toast.makeText(
//            requireContext(),
//            "Get Nama Tanaman from bottomsheet $namaTanaman success",
//            Toast.LENGTH_SHORT
//        ).show()
