...
class TenthScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_tenth_screen_cabai_polybag_menanam,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnNext = view.findViewById<MaterialButton>(R.id.btn_next_cabai_polybag_menanam10)
        val btnPrev = view.findViewById<MaterialButton>(R.id.btn_previous_cabai_polybag_menanam10)
