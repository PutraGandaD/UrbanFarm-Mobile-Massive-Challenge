...
import com.putragandad.urbanfarm.activity.panduantanampage.PanduanTanamPageActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnMetodeTanamHidroponik.setOnClickListener {
            ...
            when(namaTanaman) {
                "Bawang Merah" -> {
                    Toast.makeText(requireContext(), "Debug : nama tanaman $namaTanaman, get from bundle", Toast.LENGTH_SHORT).show()
                    startActivity(Intent(requireContext(), PanduanTanamPageActivity::class.java))
                }
            }
        }
    }
