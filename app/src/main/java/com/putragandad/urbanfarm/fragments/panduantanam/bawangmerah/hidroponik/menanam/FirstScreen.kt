...
class FirstScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_first_screen_bawangmerah_hidroponik_menanam,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnNext = view.findViewById<MaterialButton>(R.id.btn_next_bawangmerah_hidroponik_menanam1)
