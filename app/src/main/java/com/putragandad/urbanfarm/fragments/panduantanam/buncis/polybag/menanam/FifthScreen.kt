...
class FifthScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_fifth_screen_buncis_polybag_menanam,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnDone = view.findViewById<MaterialButton>(R.id.btn_next_buncis_polybag_menanam5)
        val btnPrev = view.findViewById<MaterialButton>(R.id.btn_previous_buncis_polybag_menanam5)
