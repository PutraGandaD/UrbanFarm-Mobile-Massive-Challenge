...
class SecondScreen : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnDone = view.findViewById<MaterialButton>(R.id.btn_next_timun_polybag_mediatanam2)
        val btnPrev = view.findViewById<MaterialButton>(R.id.btn_previous_timun_polybag_mediatanam2)
