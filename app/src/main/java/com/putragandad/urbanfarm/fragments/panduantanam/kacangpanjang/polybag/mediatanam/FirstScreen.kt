...
class FirstScreen : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(
            R.layout.fragment_first_screen_kacangpanjang_polybag_mediatanam,
            container,
            false
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnNext = view.findViewById<MaterialButton>(R.id.btn_next_kacangpanjang_polybag_mediatanam1)
