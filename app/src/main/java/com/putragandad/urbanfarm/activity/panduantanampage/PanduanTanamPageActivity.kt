package com.putragandad.urbanfarm.activity.panduantanampage
...
class PanduanTanamPageActivity : AppCompatActivity() {
    val tabTitle = arrayOf("Alat dan Bahan", "Panduan Tanam", "Perawatan")

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_panduan_tanam_page)
